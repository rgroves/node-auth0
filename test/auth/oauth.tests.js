...
describe('OAuthAuthenticator', function() {
  ...
  describe('#signIn', function() {
    ...
    it('should not allow an empty connection', function() {
      var auth = this.authenticator;
      var signIn = auth.signIn.bind(auth, { connection: '' });
  ...
  describe('#passwordGrant', function() {
    ...
    it('should not allow an empty password', function() {
      var auth = this.authenticator;
      var signIn = auth.passwordGrant.bind(auth, { username: 'samples@auth0.com', password: '' });
